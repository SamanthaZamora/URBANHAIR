	...
	<div class="container-fluid usuario-datos">
		<div class="row">
			...
			<div class="col-12 col-sm-12 col-md-9 col-lg-9">
				<h2 class="titulo titulo-datos-usuario">Datos Personales</h2>
				<hr>
				<div class="row ">
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="contenedor-campos">
							<input type="hidden" name="apikey"
								value="c6c212f9-f0f1-4513-99a9-1bc6161f3c8a">
							<div class="campo">
							...
							<div class="campo">
								<label for="email">Correo electronico</label> <input
									...
									value="<c:out value='${cliente.email}' />" readonly>
							</div>

							<div class="campo">
								<label for="telefono">Telefono</label> <input name="telefono"
									class="input-text" type="text"
									value="<c:out value='${cliente.telefono}' />" readonly>
							</div>
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						<div class="campo">
							<label for="genero">Genero</label> <input name="genero"
								class="input-text" type="text"
								value="<c:out value='${cliente.genero}' />" readonly>
						</div>

						<div class="campo">
							<label for="tipodocumento">Tipo de documento</label> <input
								name="tipodocumento" class="input-text"
								value="<c:out value='${cliente.tipoDocumento.tipoDocumento}' />"
								readonly>
						</div>
						...
						<div class="campo">
							<label>No. Documento</label> <input name="noDocumento"
								class="input-text" type="text"
								value="${cliente.noDocumento}" readonly>
						</div>
					</div>

					<div class="boton btn-agendar">
						<a type="submit" value="Editar" href="usuariodatosformu.jsp">Editar</a>
					</div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-12  col-sm-4 col-md-4 col-lg-4 footer-contacto">
					...
					<p>San José de Cucuta - Colombia</p>
