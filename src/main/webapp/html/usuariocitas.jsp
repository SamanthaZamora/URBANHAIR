    ...
    <body>
        ...
        <div class="container-fluid usuario-datos">
             <div class="row">
              ...
              <div class="col-md-3 col-lg-9 verticalLine">
                ...
                <section class="home-section">
                  <div class="title">            
                      ...
                      <div class="boton btn-agendar">
                          <a  href="usuarioagendar.jsp" 
                          data-bs-target="#modal1" style="margin-left: -2rem;" >Agendar Cita</a>
                          
                      </div>
                  </div>
      
                  <div class="table-responsive table-style a-cancelar">
                      <table id="example" class="table table-bordered table-striped table-hover">
                          ...
                          <tbody>
                          	...
                          	<jsp:useBean id="cita" class="co.urbanhair.dao.CitaDAO">
								</jsp:useBean>

								<c:set var="cs" scope="request" value="${cita.findByFieldList('persona',cliente)}">
								</c:set>

							
                          <c:forEach var="w" items="${cs}">
								<tr >
								<th class="enc" scope="row">${w.idCita} </th>
								
								<td>${w.servicio.nombre} </td>
								<td>${w.fecha} </td>
								<td>${w.hora} </td>
