    ...
    <body>
        <header class="header header-decoracion">
            ...
            <div class="header__texto">
                ...
                <p class="no-margin">Los mejores productos del mercado</p>
            </div>
        </header>
		...
		<h2 style="color: black !important;">Nuestros Productos</h2>
		<hr>
		
			<jsp:useBean id="pro" class="co.urbanhair.dao.ProductoDAO">
			</jsp:useBean>

			<c:set var="ps" scope="session" value="${pro.list()}">
			</c:set>
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-3 ">
						<div class="card mb-3">
							...
							<div class="card-body" style="height: 300px">
								<p class="card-title" style="color: black; font-size: 19px"> <strong>${w.nombre}</strong> </p>
								<p class="card-text" style="color: black; font-size: 15px">${w.descripcion}</p>
								<p class="card-text">
