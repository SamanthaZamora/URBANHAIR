			...
			<div class="encabezado">
				...
				<caption>
					<h1 style="margin-right: 50px">
						<c:if test="${info != null}"> Editar información empresarial </c:if>
					</h1>
				</caption>
				<c:if test="${info != null}">
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="formulario__grupo" id="grupo__telefono">
							<label for="telefono" class="formulario__label">Misión</label>
							<div class="formulario__grupo-input">
								<textarea class="form-control formulario__input" type="text"
									name="mision" placeholder="Misión de la empresa"
						...
						<div class="formulario__grupo" id="grupo__telefono">
							<label for="telefono" class="formulario__label">Visión</label>
							<div class="formulario__grupo-input">
								<textarea class="form-control formulario__input" type="text"
									name="vision" placeholder="Visión de la empresa"
