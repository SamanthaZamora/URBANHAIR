  ...
  <section class="home-section">
    ...
    <div class="title">
      ...
      <div class="titulo">
		...
		<div class="boton boton-regresar">
		<a href="<%=request.getContextPath()%>/ServletCliente?action=list">Regresar</a>
	</div>
    ...
    <div class="table-responsive table-style">
      <table id="example" class="table table-bordered table-striped table-hover">
        ...
        <tbody>
         <c:forEach var="as" items="${agenda}">
				<tr>
					<th class="enc" scope="row"><c:out value="${as.idAtencion}" /></th>
					<td><c:out value="${as.persona.nombre}" /></td>	
					<td><c:out value="${as.fecha}" /></td>				
					<td><c:out value="${as.hora}" /></td>
					<td><c:out value="${as.servicio.nombre}" /></td>					
				</tr>
			</c:forEach>
        </tbody>
      </table>     
