...
<body>
  ...
  <section class="home-section">
    ...
    <!-- TITULO CON IMG-->
    <div class="title">
      <img src="img/producto.png" width="70px" height="70px">
      <div class="titulo">
        <h1> Productos</h1>
      </div>
      ...
      <div class="boton boton-mas">
         <a type="button" class="btn btn-lg" href="<%=request.getContextPath()%>/ServletProductos?action=new">+</a>
      </div>
    </div>
      ...
      <table id="example" class="table table-bordered table-striped table-hover">
        <thead class="table-secondary">
          <tr>
            ...
            <th class="enc" scope="col">Precio Und.</th>
            <th class="enc" scope="col">Imagen</th>
            <th class="enc" scope="col">Cantidad Ext.</th>
            <th class="enc" scope="col">Proveedor</th>
        ...
        <c:forEach var="producto" items="${listaProducto}">
				<tr>
					<th class="enc" scope="row"><c:out value="${producto.idProducto}" /></th>
					<td><c:out value="${producto.nombre}" /></td>
					<td><c:out value="${producto.descripcion}" /></td>
					<td><c:out value="${producto.marca}" /></td>
					<td><c:out value="${producto.precio}" /></td>
					<td><c:out value="${producto.imgURL }" /></td>
					<td><c:out value="${producto.cantidad}" /></td>
					<td><c:out value="${producto.proveedor.razonSocial}" /></td>
					<td>
						<div class="icons-acciones">
							<a href="<%=request.getContextPath()%>/ServletProductos?action=edit&idProducto=${producto.idProducto}"><i class="fas fa-edit"></i></a>
							&nbsp;&nbsp;&nbsp;&nbsp; 
							<a href="ServletProductos?action=delete&idProducto=${producto.idProducto}"><i class="fas fa-trash-alt"></i></a>
						</div>
					</td>
				</tr>
			</c:forEach>  
