...
<body>
  ...
  <section class="home-section">
    ...
    <!-- TITULO CON IMG-->
    <div class="title">
      <img src="img/servicio.png" width="70px" height="70px">
      <div class="titulo">
        <h1> Servicios</h1>
      </div>
      ...
      <div class="boton boton-mas">
        <a type="button" class="btn btn-lg" href="<%=request.getContextPath()%>/ServletServicio?action=new">+</a>
      </div>
    </div>
      ...
      <table id="example" class="table table-bordered table-striped table-hover">
        <thead class="table-secondary">
          <tr>
            ...
            <th class="enc" scope="col">imgURL</th>
            <th class="enc" scope="col">Duración</th>
        ...
        <tbody>
			<c:forEach var="servicio" items="${listaServicio}">
				<tr>
					<th class="enc" scope="row"><c:out value="${servicio.idServicio}" /></th>
					<td><c:out value="${servicio.nombre}" /></td>
					<td><c:out value="${servicio.descripcion}" /></td>
					<td><c:out value="${servicio.precio}" /></td>
					<td><c:out value="${servicio.imgURL}" /></td>
					<td><c:out value="${servicio.duracion}" /></td>
					<td>
						<div class="icons-acciones">
							<a href="<%=request.getContextPath()%>/ServletServicio?action=edit&idServicio=${servicio.idServicio}"><i class="fas fa-edit"></i></a>
							&nbsp;&nbsp;&nbsp;&nbsp; 
							<a href="ServletServicio?action=delete&idServicio=${servicio.idServicio}"><i class="fas fa-trash-alt"></i></a>
						</div>             
					</td>
				</tr>
			</c:forEach>
