...
<body>
  ...
  <section class="home-section">
    ...
    <!-- TITULO CON IMG-->
    <div class="title">
      <img src="img/empleados.png" width="70px" height="70px">
      <div class="titulo">
        <h1> Empleados</h1>
      </div>
      ...
      <div class="boton boton-mas">
        <a type="button" class="btn btn-lg" href="<%=request.getContextPath()%>/ServletEmpleado?action=new">+</a>
      </div>
    </div>
      ...
      <table id="example" class="table table-bordered table-striped table-hover">
        <thead class="table-secondary">
          <tr>
            ...
            <th class="enc" scope="col">No. Documento</th>
            <th class="enc" scope="col">Email</th>
            <th class="enc" scope="col">Teléfono</th>            
            <th class="enc" scope="col">Fecha de nacimiento</th>
            <th class="enc" scope="col">Cargo</th>
        ...
        <c:forEach var="empleado" items="${listaEmpleado}">
				<tr>
					<th class="enc" scope="row"><c:out value="${empleado.idEmpleado}" /></th>
					<td><c:out value="${empleado.nombre}" /></td>					
					<td><c:out value="${empleado.documento}" /></td>
					<td><c:out value="${empleado.email}" /></td>
					<td><c:out value="${empleado.telefono}" /></td>
					<td><c:out value="${empleado.fechaNacimiento}" /></td>
					<td><c:out value="${empleado.tipoEmpleado.tipo}" /></td>
					<td>
						<div class="icons-acciones">
							<a href="<%=request.getContextPath()%>/ServletEmpleado?action=edit&idEmpleado=${empleado.idEmpleado}"><i class="fas fa-edit"></i></a>
						&nbsp;&nbsp;&nbsp;&nbsp; 
							<a href="ServletEmpleado?action=delete&idEmpleado=${empleado.idEmpleado}"><i class="fas fa-trash-alt"></i></a>
						</div>             
					</td>
				</tr>
			</c:forEach>
