...
<body>
      ...
      <ul class="nav-list">
        ...
        <li>
          <a href="<%=request.getContextPath()%>/ServletInfo?action=list">
            ...
            <span class="links_name">Informacion Empresarial</span>
          </a>
          <span class="tooltip">Informacion Empresarial</span>
        </li>
         <li>
  ...
  <section class="home-section">
    ...
    <!-- TITULO CON IMG-->
    <div class="title">
      <img src="img/cliente.png" width="70px" height="70px">
    ...
    <div class="boton">
      <a href="<%=request.getContextPath()%>/AgendaServlet">Ver Agendamientos</a>
    </div>
      ...
      <table id="example" class="table table-bordered table-striped table-hover">
        <thead class="table-secondary">
          <tr>
            ...
            <th class="enc" scope="col">Tipo Documento</th>
            <th class="enc" scope="col">No. Documento</th>
            <th class="enc" scope="col">Fecha de nacimiento</th>
            <th class="enc" scope="col"> Genero</th>
            <th class="enc" scope="col">Email</th>
            <th class="enc" scope="col">Telefono</th> 
          </tr>
        </thead>
        <tbody>
        <c:forEach var="cliente" items="${listaPersona}">
				<tr>
					<th class="enc" scope="row"><c:out value="${cliente.idPersona}" /></th>
					<td><c:out value="${cliente.nombre}" /></td>	
					<td><c:out value="${cliente.tipoDocumento.tipoDocumento}" /></td>				
					<td><c:out value="${cliente.noDocumento}" /></td>
