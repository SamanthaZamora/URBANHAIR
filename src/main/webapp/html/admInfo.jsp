...
<head>
    ...
    <title>Urban Hair - Administración</title>
...
<body>
    ...
    <section class="home-section">
      ...
      <!-- TITULO CON IMG-->
      <div class="title">
        <img src="img/home.png" width="70px" height="70px">
        <div class="titulo">
        ...
        <table id="example" class="table table-bordered table-striped table-hover">
          <thead class="table-secondary">
            <tr>
              ...
              <th class="enc" scope="col">Misión</th>
              <th class="enc" scope="col">Visión</th>
              <th class="enc" scope="col">Acciones</th>
            </tr>
          </thead>
          <tbody>
           <c:forEach var="info" items="${listaInfo}">
				<tr>
					<th class="enc" scope="row"><c:out value="${info.idInfo}" /></th>
					<td><c:out value="${info.direccion}" /></td>
					<td><c:out value="${info.telefono}" /></td>
					<td><c:out value="${info.email}" /></td>
					<td><c:out value="${info.mision}" /></td>
					<td><c:out value="${info.vision}" /></td>
					<td>
						<div class="icons-acciones">
							<a href="<%=request.getContextPath()%>/ServletInfo?action=edit&idInfo=${info.idInfo}"><i class="fas fa-edit"></i></a>
							&nbsp;&nbsp;&nbsp;&nbsp; 
							<a href="ServletInfo?action=delete&idInfo=${info.idInfo}"><i class="fas fa-trash-alt"></i></a>
						</div>
					</td>
				</tr>
			</c:forEach>
